...
.LFB4933:
	...
	.p2align 3
.L45:
	vmovups	-128(%rcx), %ymm10
	vxorps	%xmm7, %xmm7, %xmm7
	movl	%r14d, %ebx
	vmovups	%ymm14, (%rcx)
	vmovups	%ymm14, 32(%rcx)
	movq	%r15, %rdi
	vmovaps	%ymm7, %ymm6
	vmovaps	%ymm7, %ymm5
	vmovups	-192(%rcx), %ymm12
	vmovups	%ymm14, 64(%rcx)
	xorl	%edx, %edx
	vmovups	-160(%rcx), %ymm11
	vmovups	-224(%rcx), %ymm9
	.p2align 4,,10
	.p2align 3
.L43:
	leaq	-32(%rdi), %r11
...
.L44:
	...
	call	printf
	vxorps	%xmm0, %xmm0, %xmm0
	vaddss	-208(%rbp), %xmm0, %xmm0
	vaddss	-204(%rbp), %xmm0, %xmm0
	vaddss	-200(%rbp), %xmm0, %xmm0
	vaddss	-196(%rbp), %xmm0, %xmm0
	vaddss	-192(%rbp), %xmm0, %xmm0
	vaddss	-188(%rbp), %xmm0, %xmm0
	vaddss	-184(%rbp), %xmm0, %xmm0
	vaddss	-180(%rbp), %xmm0, %xmm0
...
.L72:
	...
	vfmadd132sd	.LC34(%rip), %xmm2, %xmm0
...
.L87:
	...
	vfmadd132sd	.LC34(%rip), %xmm3, %xmm0
	...
	vfmadd132sd	.LC34(%rip), %xmm4, %xmm0
	vcvtsd2ss	%xmm0, %xmm0, %xmm0
...
.L102:
	...
	vmovss	24(%rbx), %xmm1
	vmovss	.LC41(%rip), %xmm2
	vandps	%xmm2, %xmm0, %xmm0
	vcvtss2sd	%xmm0, %xmm0, %xmm0
	vmovss	8(%rsp), %xmm6
	vmulss	.LC43(%rip), %xmm6, %xmm2
...
.L128:
	...
	vfmadd132sd	.LC34(%rip), %xmm5, %xmm0
	vcvtsd2ss	%xmm0, %xmm0, %xmm0
	vmulss	%xmm0, %xmm0, %xmm0
	vfmadd231ss	%xmm2, %xmm2, %xmm0
	vucomiss	%xmm6, %xmm0
...
.L268:
	...
	movq	-88(%rbp), %r8
	movl	$.LC61, %edi
	vcvtss2sd	-168(%rbp), %xmm0, %xmm0
	vmovsd	%xmm5, -392(%rbp)
	cmove	-160(%rbp), %r15
	vxorpd	%xmm3, %xmm3, %xmm3
	vxorpd	%xmm2, %xmm2, %xmm2
	vcvtss2sd	-208(%rbp), %xmm3, %xmm3
	pushq	-72(%rbp)
	vcvtss2sd	-176(%rbp), %xmm2, %xmm2
	testq	%rax, %rax
	cmovne	%rax, %rcx
	movl	$4, %eax
	call	printf
...
.L229:
	...
	jle	.L270
	movq	-216(%rbp), %rcx
	movl	$0x00000000, -164(%rbp)
	vbroadcastss	-168(%rbp), %ymm8
	vmovaps	.LC24(%rip), %ymm9
	vmovaps	%ymm8, -368(%rbp)
	testq	%rcx, %rcx
	movq	%rcx, %rax
	cmovns	%rcx, %rbx
	subq	$1, %rax
...
.L272:
	...
	vxorpd	%xmm3, %xmm3, %xmm3
	movq	%r11, %r9
	vmovaps	%ymm9, -432(%rbp)
	imulq	$1000000000, -288(%rbp), %rdi
	imulq	$1000000000, -304(%rbp), %rdx
	addq	-296(%rbp), %rdi
	addq	-312(%rbp), %rdx
	addq	%rsi, %rcx
	movq	%rbx, %rsi
	imulq	$1000000000, -272(%rbp), %rax
	movq	%r11, -272(%rbp)
	addq	-280(%rbp), %rax
	movq	%rdi, %r8
	subq	%rdx, %rcx
	...
	imulq	$1000000000, -256(%rbp), %rdx
	vcvtsi2sdq	%rcx, %xmm3, %xmm3
	addq	-264(%rbp), %rdx
	subq	%rax, %r8
	vcvtsi2sdq	%r8, %xmm4, %xmm4
	movq	-328(%rbp), %r8
	vmulsd	.LC65(%rip), %xmm3, %xmm3
	vmulsd	.LC65(%rip), %xmm2, %xmm2
	subq	%rdx, %rax
	movq	%r14, %rdx
	...
	movq	%r8, %r10
	vmovsd	%xmm4, -264(%rbp)
	vmulsd	.LC65(%rip), %xmm0, %xmm0
	subq	%r14, %r10
	vmulsd	.LC65(%rip), %xmm4, %xmm1
	movq	%r10, %rcx
	movq	%r10, -208(%rbp)
	movq	-320(%rbp), %r14
	movq	%rax, %rdi
	...
	vcvtss2sd	-248(%rbp), %xmm1, %xmm1
	call	printf
	vmovaps	-432(%rbp), %ymm9
	jmp	.L244
.L271:
	vmovss	-244(%rbp), %xmm7
	movq	%rbx, %rdx
