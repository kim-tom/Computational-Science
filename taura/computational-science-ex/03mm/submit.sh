#!/bin/bash
#PBS -q u-lecture
#PBS -l select=1:ncpus=1:mpiprocs=1:ompthreads=28
...
batch_main() {
	...
	# =========================
	perf stat ./exe/mm_seq.exe -M 2048 -N 2048 -K 2048 -r 5   
        perf stat ./exe/mm_ilp.exe -M 2048 -N 2048 -K 2048 -r 5
        perf stat ./exe/mm_mp.exe -M 2048 -N 2048 -K 2048 -r 5
    else
	$CMDLINE
    fi
}
